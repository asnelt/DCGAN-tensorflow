...
def get_figures(main_folder,dataset,num_classes,classes_proportion,num_samples,num_bins,ref_period,pp,ac_or_prob):
...
if option==1 or all_options:
    ...
    ref_period = -1
    get_figures(main_folder,dataset,num_classes,classes_proportion,num_samples,num_bins,ref_period,pp,ac_or_prob)
    if not all_options:
        pp.close()
